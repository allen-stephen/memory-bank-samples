...
# Import the Memory Bank configuration defined in agent_engine_app.py.
# This is the key integration point: the deploy script reads the config and
# passes it via context_spec so the Agent Engine instance is created with
# Memory Bank enabled and configured.
from app.agent_engine_app import memory_bank_config
