...
# This callback triggers memory generation after each agent turn. On Cloud Run,
# it sends session events to VertexAiMemoryBankService (configured via
# memory_service_uri in fast_api_app.py), which extracts user preferences and
# facts for retrieval in future sessions.
#
